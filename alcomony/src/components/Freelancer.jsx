function Freelancer() {
  return (
    <div className="min-h-screen w-full bg-gray-800 text-white flex flex-col">
      {/* Header Section */}
      <header className="p-8 text-center">
        <h1 className="text-5xl sm:text-6xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent drop-shadow-lg">
          Freelance Connect
        </h1>
        <p className="mt-4 text-xl sm:text-2xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
      ...
      <main className="flex-1 p-8 space-y-10">
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-gray-700 p-6 rounded-xl shadow-lg transform hover:scale-105 transition duration-300">
        ...
        {/* Benefits Section */}
        <section className="bg-gray-700 p-8 rounded-xl shadow-lg">
